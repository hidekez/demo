...
//category = new Category("ビジネス").save();
//user = new User.Builder()
//		.itemId(iid)
//		// .uid()
//		.createdAt(new Date("2010-09-24"))
//		.enteredAt(new Date("2013-01-12"))
//		.state(ItemStateType.OK)
//		.userId(1)
//		.screenName("taro_san")
//		.userName("山田太郎")
//		.profileImageUrl(
...
//		.timeZone(TwitterTimeZone.getEnumByName("Tokyo"))
//		.utcOffset(0)
//		.location("dummy")
//		.description("dummy")
//		// .url()
...
//tweet = new Tweet("tarotwt1", user, "Hello World").save();
//account = new Account(user).save();
